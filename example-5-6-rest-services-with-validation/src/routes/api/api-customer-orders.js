 ...
 * req.customer. If the order in the request body is not valid, a 422 error will be returned. Otherwise, a 201 will be returned
 * with a Location pointing to that new order.
 */
router.post("/", (req, res) => {
  try {
